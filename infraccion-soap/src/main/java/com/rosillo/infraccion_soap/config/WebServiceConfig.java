package com.rosillo.infraccion_soap.config;
...
public class WebServiceConfig  extends WsConfigurerAdapter{
	...
	//localhost:8081/ws/infraccion.wsdl
	...
	public DefaultWsdl11Definition defaultWsdl11Definition2(XsdSchema articulosSchema) {
		...
		wsdl11Definition.setTargetNamespace("http://www.Gutierrez.com/infraccionservice");
